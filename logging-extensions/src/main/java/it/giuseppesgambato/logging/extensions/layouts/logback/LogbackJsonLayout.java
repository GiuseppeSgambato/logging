...
public class LogbackJsonLayout extends LayoutBase<ILoggingEvent> implements IJsonLayout {

    @Override
    public String doLayout(ILoggingEvent logEvent)
    {
        String log = toJson(logEvent.getTimeStamp(),
                            ...
                            LogGenerator.converterStringInLong(MDC.get(TipologiaAttributoLogEnum.PID.name())),
                            ...
                            LogGenerator.converterStringInLong(MDC.get(TipologiaAttributoLogEnum.RESULTCODE.name())),
                            LogGenerator.converterStringInLong(MDC.get(TipologiaAttributoLogEnum.ERRORCODE.name())),
                            MDC.get(TipologiaAttributoLogEnum.ERRORMESSAGE.name()),
                            LogGenerator.converterStringInLong(MDC.get(TipologiaAttributoLogEnum.TIME.name())),
